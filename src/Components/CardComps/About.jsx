function About() {
    return (
        <div className={`bg-[#0000] font-['Jersey_25'] h-full min-w-[80%] w-[80%] [corner-shape:bevel] rounded-tl-4xl rounded-br-4xl border-3 border-[#c8ffc8] p-4 overflow-hidden`}>
            ...
            <p>Aiming to be a skilled Developer, while enhancing my skills in related Frameworks, to become a proficient developer with ability to create efficient Applications.</p>
            <br />
            <h1>Education</h1>
            <div>
                <div >
                ...
                <div >
                    <h3>10th</h3>
                    <div className="flex flex-row justify-between items-center">
                        <p>Army Public School Khadakwasla</p>
